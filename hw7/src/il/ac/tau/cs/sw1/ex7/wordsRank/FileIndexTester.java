...
import il.ac.tau.cs.sw1.ex7.AbstractTester;

public class FileIndexTester extends AbstractTester {
	
	public static final String INPUT_FOLDER = "./resources/hw7/input";
	...
	public static void testFileIndex(){
		...
		List<String> topByAvg = fIndex.getWordsWithAverageRankSmallerThanK(6);
