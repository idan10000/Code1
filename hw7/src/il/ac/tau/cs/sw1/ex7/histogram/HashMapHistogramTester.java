...
import il.ac.tau.cs.sw1.ex7.histogram.IllegalItemException;
...
public class HashMapHistogramTester {
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("threw error 7 (this is good)");
		}
		...
		try {
			stringHist.removeItemKTimes("abc", -3); // this should throw an exception
